...
public class magazin implements Iterable<Cl>{
    ArrayList<Cl> cls;
    ...
    void selectAll(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Cl cl =  ClockFactory.new_watch((type == 0)?Type.Clock:Type.Clock_3,rs.getString("name"),rs.getFloat("price"));
    ...
    private String Ow;
    public String GetOw(){return Ow;}
    public void SetOw(String Ow){this.Ow = Ow;}
    ...
    public magazin(String title, String Ow) {
        cls = new ArrayList<>();
        this.title = title;
        this.Ow = Ow;
        connect();
